                   ...
                   tabPanel("Next Word Predictor",
                            sidebarLayout(
                                    sidebarPanel(
                                            ...
                                            h5(strong("Resources :")),
                                            h5("1. " , a(" Link to the Rpubs Reproducible Pitch presentation on the Next Word Predictor App.", href="http://rpubs.com/AniruddhaChakraborty/301943")),
                                            ...
                                            h5("3. " , a(" Link to the source code of n-gram Language model and Interpolation Prediction Algorithm.", href="https://github.com/AniruddhaChakraborty/Data-Science-Capstone-Course-Project/tree/master/Next_Word_Predictor")),
                                            h5("4. " , a(" Link to the source code of ui.R and server.R files.", href="https://github.com/AniruddhaChakraborty/Data-Science-Capstone-Course-Project/tree/master/Shiny_App-Next_Word_Predictor"))                       
                                    ),
